...
public class FirstTest {
    ...
    public void testChangeScreenOrientationOnSearchResults(){
        ...
        String title_before_rotation = waitForElelementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
        ...
        String title_after_rotation = waitForElelementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                15
        ...
        String title_after_second_rotation = waitForElelementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                15
    ...
    private String waitForElelementAndGetAttribute(By by, String attribute, String error_message, long timeoutInSeconds){
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
