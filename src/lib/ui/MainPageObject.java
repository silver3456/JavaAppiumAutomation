...
public class MainPageObject {
    ...
    public void swipeUpToFindElemend(By by, String errorMessage, int max_swipes) {
    ...
    public String waitForElelementAndGetAttribute(By by, String attribute, String error_message, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
